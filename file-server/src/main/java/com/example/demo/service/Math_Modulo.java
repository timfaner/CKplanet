...
final static BigInteger GENERATOR  	= new BigInteger("79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798",16);  	// Bitcoin Generrator Punkt  G =  02 79BE667E F9DCBBAC 55A06295 CE870B07 029BFCDB 2DCE28D9 59F2815B 16F81798
...
while (t.equals(ONE)==false)
{
    ...
    while (tt.equals(ONE)==false)
    {
        ...
        if (i.equals(m))
        {
            if(n.equals(ZERO)==false) System.out.println("\nFehler!  sqrt("+n+") existiert nicht! (Math_Modulo.sqrt) \n");
            return ZERO;
        }
    }
